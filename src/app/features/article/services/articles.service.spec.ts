...
describe('ArticlesService', () => {
  ...
  describe('create', () => {
    ...
    it('should create an article and fetch it (real functional test)', () => {
      const newArticle = {
        title: 'Test Article',
        description: 'Test Description',
        body: 'Test Body',
      ...
      const getReq = httpMock.expectOne('/articles/test-article');
      expect(getReq.request.method).toBe('GET');
      getReq.flush({ article: { ...newArticle, slug: 'test-article', author: {}, createdAt: '', updatedAt: '' } });
    });
  });
